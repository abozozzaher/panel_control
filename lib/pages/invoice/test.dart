...
pw.Center(
          child: pw.Text(
            'Invoice Data:$prices  all price $allPrices سعر كل سطر= $shippingFees اجور الشحن = $previousDebts الدين السابق= $grandTotalPrice السعر الكلي ${aggregatedData.toString()}',
            style: pw.TextStyle(
                font: fontTajRegular,
                fontSize: 18,
...
class Invoice {
  ...
  Future<Uint8List> buildPdf() async {
    ...
    _bgShape = await rootBundle.loadString('assets/img/logo.svg');
