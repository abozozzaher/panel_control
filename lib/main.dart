...
/*
 DataTabelFetcher حفظ البيانات في البروفيدر وفي حال اعادة طلب البيانات النظر في البروفيدر من جديد هل متوفرة ام لا
...
تعديل الرول في الفاير بيس صلاحيات الادمن تعديلها
انشاء صفحة مثل الفاتورة يتم اضافة البيانات العملية ويتم تصويرها وارسالها الى العميل
شكل الفاتورة مثل التي في رابط هذا
